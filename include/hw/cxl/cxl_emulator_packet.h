...
typedef struct
{
    system_header_packet_t system_header;
    cxl_io_header_t dw0;
} __attribute__((packed)) opencxl_tlp_header_dw0_t;
...
typedef enum cxl_mem_m2s_req_opcode
{
    MEM_RD = 1
} cxl_mem_m2s_req_opcode_t;

typedef enum cxl_mem_m2s_rwd_opcode
{
    MEM_WR = 1
} cxl_mem_m2s_rwd_opcode_t;
